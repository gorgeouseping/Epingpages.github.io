...
<div style="display: flex; align-items: center; width: 100%;">
  <div style="flex: 30%;">
    <a>
        <img src="" alt="JointYipengZhao" style="width: 90%;"/>
    </a>
  </div>
  <div style="flex: 70%;">
...
<div style="display: flex; align-items: center; width: 100%;">
  <div style="flex: 30%;">
    <a>
        <img src="" alt="SurveyZhiyunZhuang" style="width: 90%;"/>
    </a>
  </div>
  <div style="flex: 70%;">
...
<div style="display: flex; align-items: center; width: 100%;">
  <div style="flex: 30%;">
    <a>
        <img src="" alt="Low-FaceNet" style="width: 90%;"/>
    </a>
  </div>
  <div style="flex: 70%;">
...
- <strong>A Deep-Learning-Based Method for Extracting an Arbitrary Number of Individual Power Lines from UAV-Mounted Laser Scanning Point Clouds</strong>, Sha Zhu, Qiang Li, Jianwei Zhao, Chunguang Zhang, Guang Zhao, Lu Li, Zhenghua Chen*, <strong>Yiping Chen</strong>, *Remote Sensing* 2024
- 
